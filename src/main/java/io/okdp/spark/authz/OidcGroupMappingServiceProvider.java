 ...
 * This implementation fetches the list of the groups membership of the user which are already
 * cached during the authentication phase. The groups correspond to the roles and groups claims
