...
```shell
ADD https://repo1.maven.org/maven2/io/okdp/okdp-spark-auth-filter/1.3.3/okdp-spark-auth-filter-1.3.3.jar ${SPARK_HOME}/jars
```
...
Copy the jar https://repo1.maven.org/maven2/io/okdp/okdp-spark-auth-filter/1.3.3/okdp-spark-auth-filter-1.3.3.jar into `${SPARK_HOME}/jars/` in the different spark nodes
